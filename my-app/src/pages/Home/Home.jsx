...
export const Home = () => {
    ...
    const bannerMarginLeft = useBreakpointValue({ base: '10px', md: '150px' });
    ...
    return (
        <Box >
            <Box id="banner">
                <Box marginLeft={bannerMarginLeft} >
                    <Heading className ="top" color ={"rgb(0,61,41)"} size={"4xl"} marginBottom={"20px"} >Shopping And</Heading>
                    <Heading className="top" color={"rgb(0,61,41)"} size={"4xl"} marginBottom={"20px"}>Department Store</Heading>
            ...
            <Box marginTop={"100px"} >
                ...
                <Grid className="category" width={"90%"} margin={"auto"} justifyContent={"center"} gap={"20px"} >
            ...
            <Box marginTop={"100px"} id="middlebanner" bgImage={"url(https://img.freepik.com/premium-photo/living-room-modern-style-with-sofa-chair-yellow-green-wall-background_258219-553.jpg?w=996)"}>
                <Box id="middlebox">
                    <Heading className="ware" marginBottom={"20px"} >Get 5% Cash Back On $200</Heading>
                    <Text className="ware2"marginBottom={"40px"} >Shopping is a bit of a relaxing hobby for me, which is sometimes troubling for the bank balance.</Text>
            ...
            <Box marginTop={"100px"}  >
                ...
                <Grid id="itemgrid2" marginTop={"50px"}>
